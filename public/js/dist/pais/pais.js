    ...
    acciones(){
      ...
      $('#search').keypress(function(event){
        ...
        console.log(BASEURL);
          ...
          const _this = this
              ...
              const table = $('#pais').DataTable( {
                  ...
                  "ajax": {
                      ...
                      "data": function ( d ) {
                          var info = $('#pais').DataTable().page.info();
          ...
          desactivarpais(){
              ...
              $( ".desactivar" ).off('click');
                $( ".desactivar" ).click(function() {
                    ...
                    const paisId = $( this ).attr( "attr-id" );
                    var opciones = {paisId:paisId};
                    const message = 'Seguro que desea cambiar de estatus el pais?'
                    const objConfirmacionmodal = new Confirmacionmodal(message, opciones, _this.callbackDesactivarpais);
          ...
          callbackDesactivarpais(response, opciones){
                  ...
                  .done(function( data ) {
                    ...
                    console.log('por aqui vamos')
                      ...
                      if(data.response == true){
                          const modalTitle = 'pais';
                          const modalMessage = 'El pais ha sido cambiado de estatus';
                          const objMessagebasicModal = new MessagebasicModal(modalTitle, modalMessage);
                          objMessagebasicModal.init();

                          const objDistpaiss = new Distpais();							
                          objDistpaiss.init();	
                          //objDistpaiss.paiss($( "#search" ).val());

                      }else{
                          
                          const modalTitle = 'pais';
                          const modalMessage = 'El pais no se ha podido cambiar de estatus';
                          const objMessagebasicModal = new MessagebasicModal(modalTitle, modalMessage);
                          objMessagebasicModal.init();
...
$(document).ready(function(){
  ...
  const objDistpais = new Distpais();
  objDistpais.init();
