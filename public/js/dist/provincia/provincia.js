      ...
      $('#search').keypress(function(event){
        ...
        console.log(BASEURL);
          ...
          const _this = this
              ...
              const table = $('#provincia').DataTable( {
                  "destroy": true,
                  "searching": false,
                  "serverSide": true,
                  "info": true,
                  ...
                  "ajax": {
                      ...
                      "data": function ( d ) {
                          var info = $('#provincia').DataTable().page.info();
          ...
          desactivarprovincia(){
              ...
              $( ".desactivar" ).off('click');
                $( ".desactivar" ).click(function() {
                    ...
                    const provinciaId = $( this ).attr( "attr-id" );
                    var opciones = {provinciaId:provinciaId};
                    const message = 'Seguro que desea cambiar de estatus el provincia?'
                    const objConfirmacionmodal = new Confirmacionmodal(message, opciones, _this.callbackDesactivarprovincia);
          ...
          callbackDesactivarprovincia(response, opciones){
              ...
              if(response == true){
                  ...
                  {
                      provinciaId: opciones.provinciaId,
                      _token:token 
                      }
                  )
                  .done(function( data ) {
                    ...
                    console.log('por aqui vamos')
                      ...
                      if(data.response == true){
                          const modalTitle = 'provincia';
                          const modalMessage = 'El provincia ha sido cambiado de estatus';
                          const objMessagebasicModal = new MessagebasicModal(modalTitle, modalMessage);
                          objMessagebasicModal.init();

                          const objDistprovincias = new Distprovincia();							
                          objDistprovincias.init();	
                          //objDistprovincias.provincias($( "#search" ).val());

                      }else{
                          
                          const modalTitle = 'provincia';
                          const modalMessage = 'El provincia no se ha podido cambiar de estatus';
                          const objMessagebasicModal = new MessagebasicModal(modalTitle, modalMessage);
                          objMessagebasicModal.init();
...
$(document).ready(function(){
  ...
  const objDistprovincia = new Distprovincia();
  objDistprovincia.init();
