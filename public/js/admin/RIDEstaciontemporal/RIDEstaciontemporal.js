class Adminestaciontemporal {
    ...
    init(){
        ...
        if($('#nuevoregistro').length) {
          this.estaciontemporal();
      }

      if($('#nuevoregistro').length) {
          this.validateestaciontemporal();
      }

      if($('#estaciontemporal').length) {
        this.estaciontemporal();
    }
    ...
    acciones(){
        ...
        $( "#searchButton" ).click(function() {
          _this.estaciontemporal( $( "#search" ).val() );
      });
      ...
      $('#search').keypress(function(event){
        ...
        console.log(BASEURL);
          ...
          const _this = this
              ...
              const table = $('#estaciontemporal').DataTable( {
                  "destroy": true,
                  "searching": false,
                  "serverSide": true,
                  "info": true,
                  ...
                  "ajax": {
                      ...
                      "data": function ( d ) {
                          var info = $('#estaciontemporal').DataTable().page.info();
                  ...
                  "infoCallback": function( settings, start, end, max, total, pre ) {
                      ...
                      _this.desactivarestaciontemporal();
          ...
          desactivarestaciontemporal(){
              ...
              $( ".desactivar" ).off('click');
                $( ".desactivar" ).click(function() {
                    ...
                    const estaciontemporalId = $( this ).attr( "attr-id" );
                    var opciones = {estaciontemporalId:estaciontemporalId};
                    const message = 'Seguro que desea cambiar de estatus el estaciontemporal?'
                    const objConfirmacionmodal = new Confirmacionmodal(message, opciones, _this.callbackDesactivarestaciontemporal);
          ...
          callbackDesactivarestaciontemporal(response, opciones){
              ...
              if(response == true){
                  ...
                  {
                      estaciontemporalId: opciones.estaciontemporalId,
                      _token:token 
                      }
                  )
                  .done(function( data ) {
                    ...
                    console.log('por aqui vamos')
                      ...
                      if(data.response == true){
                          const modalTitle = 'estaciontemporal';
                          const modalMessage = 'El estaciontemporal ha sido cambiado de estatus';
                          const objMessagebasicModal = new MessagebasicModal(modalTitle, modalMessage);
                          objMessagebasicModal.init();

                          const objAdminestaciontemporal = new Adminestaciontemporal();							
                          objAdminestaciontemporal.init();	
                          //objAdminestaciontemporal.estaciontemporal($( "#search" ).val());

                      }else{
                          
                          const modalTitle = 'estaciontemporal';
                          const modalMessage = 'El estaciontemporal no se ha podido cambiar de estatus';
                          const objMessagebasicModal = new MessagebasicModal(modalTitle, modalMessage);
                          objMessagebasicModal.init();

                          //const objAdminestaciontemporal = new Adminestaciontemporal();							
                          //objAdminestaciontemporals.estaciontemporal($( "#search" ).val());
                      }
                  })
                  .fail(function() {
