                    ...
                    <form id="nuevoregistro" name="nuevoregistro" method="POST" action="{{ url()->current('/admin/RIDAfinidad/nuevo') }}" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="col-lg-6 m-b-10">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text" style="width: 150px;" >Descripcion</span>
                                <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="">
                            </div>

                            <div class="input-group mb-3">
                                <label class="input-group-text" style="width: 150px;" for="tipoAfinidad">Tipo de Afinidad</label>
                                <select class="form-select" id="tipoAfinidad" name="tipoAfinidad">
                                    <option value="" selected disabled>Selecciona...</option>
                                    @foreach (['Parentesco Directo (Consanguíneo)', 'Parentesco Colateral', 'Parentesco por Afinidad', 'Sin Parentesco'] as $value) 										
