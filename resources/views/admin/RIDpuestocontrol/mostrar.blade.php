                ...
                <div class="container-fluid px-2 my-2">
                        ...
                        <div class="col-lg-6 m-b-10">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="descripcion" name="descripcion" type="text" placeholder="Descripcion" readonly value="{{$RIDPuestoControl->descripcion}}"/>
                                    <label for="descripcion">Descripcion</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input class="form-control" id="codigo" name="codigo" type="text" placeholder="Codigo" readonly value="{{$RIDPuestoControl->codigo}}"/>
