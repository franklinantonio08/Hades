    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-body p-4">
                ...
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <h4 class="card-title fw-semibold">Lista de Permisos</h4>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered data-table" id="migrantes">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-primary fs-8 fw-semibold text-white">Descripcion</th>
...
@section('scripts')
    ...
    <!-- JS Específicos -->
    <script src="{{ asset('../js/dist/permisos/permisos.js') }}" type="text/javascript"></script>
