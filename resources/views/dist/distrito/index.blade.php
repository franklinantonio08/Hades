...
<script type="text/javascript" src="{{ asset('../js/dist/provincia/provincia.js') }}"></script>
...
@section('content')
	...
	<div class="col-lg-12">
        <div class="card mb-4">
			...
			<div class="row">
				<div class="col">
				<div class="card-title fs-4 fw-semibold">Lista de provincia</div>
...
<div class="row">
	...
	<div class="table-responsive">
						...
						<table class="table table-bordered data-table" id="provincia">
							<thead>
								<tr>
