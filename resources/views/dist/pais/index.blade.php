...
<script type="text/javascript" src="{{ asset('../js/dist/pais/pais.js') }}"></script>
...
@section('content')
	...
	<div class="col-lg-12">
        <div class="card mb-4">
			...
			<div class="row">
				<div class="col">
				<div class="card-title fs-4 fw-semibold">Lista de Paises</div>
...
<div class="row">
	...
	<div class="table-responsive">
						...
						<table class="table table-bordered data-table" id="pais">
							<thead>
								<tr>
									...
									<th class="bg-primary fs-8 fw-semibold text-white">Código Alfa 3</th>
