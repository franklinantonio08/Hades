        ...
        <div class="card mb-4">
            ...
            <div class="table-responsive">
                ...
                <div class="container-fluid px-2 my-2">
                    <form id="nuevoregistro" name="nuevoregistro" method="POST" action="{{ url()->current('/dist/motivo/nuevo') }}" enctype="multipart/form-data" autocomplete="off">
                            {{ csrf_field() }}
                            
                            <input type="hidden" id="motivoId" name="motivoId" value="{{$motivo->id}}" class="form-control text-right" placeholder="">

                        <div class="col-lg-5 m-b-6">

                                <div class="input-group mb-3">
                                    <span class="input-group-text" style="width: 130px;">Nombre</span>
                                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder=""value="{{$motivo->descripcion}}">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" id="departamento" name="departamento">
                                        ...
                                        @if($motivo->departamento == $value->nombre)
                                  ...
                                  <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" id="estatus" name="estatus">
                                        @foreach(['Activo', 'Inactivo'] as $opcion)
                                            <option value="{{ $opcion }}" {{ $motivo->estatus == $opcion ? 'selected' : '' }}>
                                                {{ ucfirst($opcion) }}
                                            </option>
                                        @endforeach
                                    </select>
