...
@section('content')
	...
	<div class="col-lg-12">
        <div class="card mb-4">
			...
			<div class="row">
				<div class="col">
				<div class="card-title fs-4 fw-semibold">Organizacion</div>
						...
						<table class="table table-bordered data-table" id="departamento">
							<thead>
								<tr>
									...
									<th class="bg-primary fs-8 fw-semibold text-white">Regional</th>
									<th class="bg-primary fs-8 fw-semibold text-white">Formato</th>
									<th class="bg-primary fs-8 fw-semibold text-white">Nombre Seg.</th>
									<th class="bg-primary fs-8 fw-semibold text-white">Direccion</th>
									<th class="bg-primary fs-8 fw-semibold text-white">Cebe Ceco</th>
									<th class="bg-primary fs-8 fw-semibold text-white">Nomb. CEBECECO</th>
									<th class="bg-primary fs-8 fw-semibold text-white">Estatus</th>
									<th class="bg-primary fs-8 fw-semibold text-white"><i class="fa fa-ellipsis-h"></i></th>
								</tr>
							</thead>
							<tbody>
								<tr class="gradeX">
