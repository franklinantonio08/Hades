                ...
                <ul class="header-nav ms-auto me-3">
                    ...
                    <li class="nav-item dropdown d-md-down-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg py-0">
                            <div class="dropdown-header bg-light fw-semibold dark:bg-white dark:bg-opacity-10">
                                You have 5 pending tasks
                            </div>
                            <a class="dropdown-item d-block" href="#">
                                <div class="small mb-1">Upgrade NPM &amp; Bower
                                    <span class="float-end"><strong>0%</strong></span>
                                </div>
                                <span class="progress progress-thin">
                            ...
                            <a class="dropdown-item d-block" href="#">
                                <div class="small mb-1">ReactJS Version
                                    <span class="float-end"><strong>25%</strong></span>
                                </div>
                                <span class="progress progress-thin">
                            ...
                            <a class="dropdown-item d-block" href="#">
                                <div class="small mb-1">VueJS Version
                                    <span class="float-end"><strong>50%</strong></span>
                                </div>
                                <span class="progress progress-thin">
                            ...
                            <a class="dropdown-item d-block" href="#">
                                <div class="small mb-1">Add new layouts
                                    <span class="float-end"><strong>75%</strong></span>
                                </div>
                                <span class="progress progress-thin">
                            ...
                            <div class="p-2">
                                <a class="btn btn-outline-primary w-100" href="#">View all tasks</a>
                            </div>
                        </div>
                    </li>--}}
                    <li class="nav-item dropdown d-md-down-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg pt-0">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="message">
                                    <div class="py-3 me-3 float-start">
                                        <div class="avatar">
                                            <img class="avatar-img" src="{{ asset('images/7.jpeg') }}" alt="user@email.com">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="message">
                                    <div class="py-3 me-3 float-start">
                                        <div class="avatar">
                                            <img class="avatar-img" src="{{ asset('images/6.jpeg') }}" alt="user@email.com">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="message">
                                    <div class="py-3 me-3 float-start">
                                        <div class="avatar">
                                            <img class="avatar-img" src="{{ asset('images/5.jpeg') }}" alt="user@email.com">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="message">
                                    <div class="py-3 me-3 float-start">
                                        <div class="avatar">
                                            <img class="avatar-img" src="{{ asset('images/4.jpeg') }}" alt="user@email.com">
                                            <span class="avatar-status bg-info"></span>
                                        </div>
                                    </div>
                                    <div>
                                        <small class="text-medium-emphasis">John Doe</small>
                                        <small class="text-medium-emphasis float-end mt-1">4:03 PM</small>
                                    </div>
                                    <div class="text-truncate font-weight-bold">Lorem ipsum dolor sit amet</div>
                                    <div class="small text-medium-emphasis text-truncate">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt...
                    ...
                    <li class="nav-item dropdown d-flex align-items-center">
                        <a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                            <div class="avatar avatar-md">
                                <img class="avatar-img" src="{{ asset('images/11.png') }}" alt="user avatar">
                                <span class="avatar-status bg-success"></span>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            ...
                            {{-- <a class="dropdown-item d-flex align-items-center" href="#">
                                ...
                                Updates<span class="badge bg-info-gradient ms-auto">42</span>
                            </a>
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <svg class="icon me-2">
                                    <use xlink:href="{{ asset('../vendors/@coreui/icons/svg/free.svg#cil-envelope-open') }}"></use>
                                </svg> 
                                Messages<span class="badge bg-success ms-auto">42</span>
                            </a> --}}
                            <!-- Additional Items -->
                            {{-- <a class="dropdown-item d-flex align-items-center" href="#">
                                <svg class="icon me-2">
                                ...
                                Tasks<span class="badge bg-danger-gradient ms-auto">42</span>
                            </a> --}}
                            {{-- <a class="dropdown-item d-flex align-items-center" href="#">
                                <svg class="icon me-2">
                                    <use xlink:href="{{ asset('../vendors/@coreui/icons/svg/free.svg#cil-comment-square') }}"></use>
                                </svg> 
                                Comments<span class="badge bg-warning-gradient ms-auto">42</span>
                            </a> --}}

                            {{-- <a class="dropdown-item d-flex align-items-center" href="{{ route('perfil.Editar') }}">
                                <svg class="icon me-2 text-success">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                ...
                                Payments<span class="badge bg-secondary-gradient ms-auto text-dark">42</span>
                            </a>
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <svg class="icon me-2">
                                    <use xlink:href="{{ asset('../vendors/@coreui/icons/svg/free.svg#cil-file') }}"></use>
                                </svg> 
                                Projects<span class="badge bg-primary-gradient ms-auto">42</span>
                            </a> --}}
                            ...
                            <form method="POST" action="{{ route('logout') }}" class="dropdown-item p-0">
                                @csrf
                               <button type="submit" class="btn btn-link dropdown-item d-flex align-items-center w-100">
                                    <svg class="icon me-2 text-danger"> <!-- rojo -->
