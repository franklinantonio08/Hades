        ...
        <!--
                ...
                <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                        ...
                        <ul class="nav-group-items">
                                ...
                                @if (Auth::user()->usuariopermiso('007'))
                                        <li class="nav-item"><a class="nav-link" href="/dist/permisos"><span class="nav-icon"></span> Permisos</a></li>
                                @endif

                                @if (Auth::user()->usuariopermiso('001'))
                                        <li class="nav-item"><a class="nav-link" href="/dist/usuarios"><span class="nav-icon"></span> Usuarios</a></li>
                                @endif
